...
//                        canvas.DrawBitmap(sk_img, (screenWidth - codec.Info.Width)/2, (screenHeight - codec.Info.Height)/2); // where it is on the screen


//                        ////install the pixels with the color type of the pixel data
//                        //bitmap.InstallPixels(imageInfo, pixels: gcHandle.AddrOfPinnedObject(), rowBytes: imageInfo.RowBytes, ctable: null, releaseProc: delegate { gcHandle.Free(); }, context: null);
